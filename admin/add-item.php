	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-wrap">
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					<a href="../main/index.html" class="sidebar__nav-link"><i class="ti ti-arrow-left"></i> <span>Back to HotFlix</span></a>
				</li>
			</ul>
		</div>
		<!-- end sidebar nav -->
				...
				<div class="col-12">
					<form action="#" class="sign__form sign__form--add">
						<div class="row">
							...
							<div class="col-12">
								<button type="submit" name="pubbtn"class="sign__btn sign__btn--small"><span>Publish</span></button>
							</div>
												<!-- <div class="col-md-12">
